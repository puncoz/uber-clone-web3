...
const style = {
    wrapper: `pt-2`,
    searchHeader: `w-full font-bold text-left flex items-center text-2xl p-4 overflow-hidden`,
    inputBoxes: `flex flex-col mb-4 relative`,
    inputBox: `h-10 mx-4 border-2 bg-[#eee] flex items-center my-1 py-1 px-2`,
...
export const LocationSelector: FunctionComponent<Props> = (props) => {
